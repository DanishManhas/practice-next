...
function Header({}: Props) {
  ...
  return (
    <>
      <div className="z-10 h-10 bg-red-500    flex flex-row justify-between lg:items-end">
        <span>
          {" "}
          <Image
            src="/CivilsIndia.svg"
        ...
        <nav className="w-6/12 bg-inherit">
          <button
            onClick={() => {
          ...
          <ul
            className={`z-10 font-sans clear-right h-screen lg:h-10 flex flex-col justify-start lg:items-end lg:justify-between lg:flex-row lg:visible bg-red-500   ${
              collapseMenu ? `collapse` : ``
            }`}
          >
            <li className="">item1</li>
            <li className="bg-500-red text-green-700">item2</li>
            <li>item3</li>
          </ul>
        </nav>
      </div>
